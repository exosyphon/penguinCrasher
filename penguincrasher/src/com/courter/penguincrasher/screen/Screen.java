...
public abstract class Screen {
	...
	private Penguincrasher penguincrasher;
	public SpriteBatch spriteBatch;
	static final float FRUSTUM_WIDTH = Penguincrasher.GAME_WIDTH;
	static final float FRUSTUM_HEIGHT = Penguincrasher.GAME_HEIGHT;

	public void removed () {
		spriteBatch.dispose();
	}

	public final void init (Penguincrasher penguincrasher) {
		this.penguincrasher = penguincrasher;
	...
	protected void setScreen (Screen screen) {
		penguincrasher.setScreen(screen);
	}
